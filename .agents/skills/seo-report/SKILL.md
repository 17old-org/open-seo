...
<footer>What the tools reported, and what was verified by hand.</footer>
</div></body></html>
```
...
- **`footer`** — what the tools reported and what you verified by hand.
